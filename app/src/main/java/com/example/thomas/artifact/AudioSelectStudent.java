...
public class AudioSelectStudent extends AppCompatActivity {
    ...
    private static final String TAG = "AudioSelectStudent";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_audio_select_student);
    ...
    public void openAudio(View view) {
        // pass data
        Intent intent = new Intent(AudioSelectStudent.this, GetAudio.class);
